...
lis = ["PYTHON", "APPLE", "MICROLAB", "HUMANS"] #это список слов, которые будут угадывать
...
while blanks != word: #начинаем цыкл, он будет продолжатся до того времени, пока вы не угадаете слово
    ...
    if len(letter) == 1 :   #если длина вашего ввода равна 1
        ...
        #этот блок нужен для того, что бы скравать угадываное слово, и показывать уже угаданые буквы
    ...
    elif len(letter) > 1 or len(letter) < 1:    #если вы не ввели  букву или ввели больше чем одну
        print("Введите одну букву")
print("Вы отгадали слово: {0}".format(word))    #ввывод что вы угадали слово